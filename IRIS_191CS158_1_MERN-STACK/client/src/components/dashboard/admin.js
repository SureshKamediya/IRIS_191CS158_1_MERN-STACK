...
const DashAdmin = () => {
    return (  
        <div className="dashadmin">
            ...
            <div className="card text-center mt-5 mb-5 mx-auto" style={{width: 18 + "rem"}}>
                <div className="card-body">
                    <h5 className="card-title">All The Requests</h5>
                    <p className="card-text">You can see info about all requests by the members</p>
                    <NavLink className = "btn btn-primary" to="/allTheRequests">All The Requests</NavLink>
                </div>
            </div>
        </div>
    );
